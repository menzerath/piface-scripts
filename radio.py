...
if not PY3:
    print("Radio funktioniert nur mit 'Python 3'.")
    sys.exit(1)
...
STATIONS = [
    {'name': "1Live",
     'source': '-playlist http://www.wdr.de/wdrlive/media/mp3/1live.m3u',
     'info': None},
    {'name': "1Live Diggi",
     'source': '-playlist http://www.wdr.de/wdrlive/media/mp3/1live-diggi.m3u',
     'info': None},
    {'name': "WDR 2 (Aachen)",
     'source': '-playlist http://www.wdr.de/wdrlive/media/mp3/wdr2-aachen.m3u',
     'info': None},
]
...
class Radio(object):
    ...
    def play(self):
        ...
        print("Spiele {}.".format(self.current_station['name']))
